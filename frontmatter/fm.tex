\newcommand\thesistitle{Linear Programming to Determine Molecular Orientation at Surfaces through Vibrational Spectroscopy}
% One needs to make adjustments for a Master's Thesis
\newcommand\nameanddegrees{%
Fei Chen\\
B.Sc., University of Victoria, 2017}
\newcommand\panel{%
\HRule\\\panelist{Dr. Ulrike Stege}{Co-Supervisor}{Department of Computer Science}
\HRule\\\panelist{Dr. Dennis Hore}{Co-Supervisor}{Department of Chemistry}
}
