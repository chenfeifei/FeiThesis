...
\caption{Toy model IR candidates cosine polarization} \label{fig:3.1}
...
\caption{Toy Model Result Plotting for 10 Candidates on IR Cosine Projection}\label{fig:3.3}
\end{figure}
...
\caption{Toy Model Candidates IR Sine Projection}  \label{fig:3.4}
\end{figure}
...
\hline
\end{tabular} 
\caption{Experiment 4 and 5 Setting}\label{tab:3.3}
\end{center}
\end{table}		
