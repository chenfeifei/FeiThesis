...
ax.set_title("Target composition of Experiment 2 in one random run with experiments containing scaling factor of mixed amino acids with " r'$\theta$' " expanded from " r'$0^{\circ}$' " to " r'$80^{\circ}$')
